...
class ClientesController {
    list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const respuesta = yield database_1.default.query('SELECT * FROM clientes order by idCliente');
    ...
    eliminar(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { idCliente } = req.params;
            const resp = yield database_1.default.query(`DELETE FROM clientes WHERE idClientes= ${idCliente}`);
            res.json(resp);
        });
    }
}
